  ...
  confirm(options) {
    ...
    const content = `
      <div style="text-align: center; padding: var(--spacing-lg);">
        <div style="width: 3rem; height: 3rem; margin: 0 auto var(--spacing-lg); border-radius: var(--radius-full); background-color: rgba(239, 68, 68, 0.1); display: flex; align-items: center; justify-content: center;" aria-hidden="true">
          <i class="${icons[type]}" style="font-size: 1.5rem; color: ${colors[type]};"></i>
        </div>
        <p style="margin: 0; color: var(--text-primary); overflow-wrap: break-word; word-wrap: break-word;">${escapedMessage}</p>
      </div>

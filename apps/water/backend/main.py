...
meeting_frontend_dir = os.path.join(backend_dir, "..", "..", "meeting", "frontend")
...
# ==================== v1 API 路由 ====================
from api_v1_offices import router as v1_offices_router
from api_v1_unified import router as v1_unified_router

app.include_router(v1_offices_router)
app.include_router(v1_unified_router)

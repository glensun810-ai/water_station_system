...
SERVICE_CONFIGS = {
    ...
    "meeting_room": {
        ...
        "config": {
            ...
            "advanceDays": 7,
            "bookingUnits": [
                {"value": "hour", "label": "小时", "minDuration": 1, "maxDuration": 8},
                {"value": "half_day", "label": "半天", "minDuration": 0.5, "maxDuration": 1},
                {"value": "day", "label": "天", "minDuration": 1, "maxDuration": 7},
            ],
        },
    },
    "booth": {
        ...
        "bookingRequired": True,
        "defaultUnit": "天",
        "description": "展位租赁和展览空间预订",
        "config": {
            "bookingUnits": [
                {"value": "day", "label": "天", "minDuration": 1, "maxDuration": 90},
                {"value": "week", "label": "周", "minDuration": 1, "maxDuration": 12},
                {"value": "month", "label": "月", "minDuration": 1, "maxDuration": 6},
            ],
            "minDuration": 1,
            "maxDuration": 90,
            "advanceDays": 30,
    ...
    "venue": {
        ...
        "bookingRequired": True,
        "defaultUnit": "半天",
        "description": "大型会场、活动场地预订",
        "config": {
            "timeSlots": [
                {"key": "morning", "label": "上午场 (09:00-12:00)", "durationValue": 0.5, "durationUnit": "half_day"},
                {"key": "afternoon", "label": "下午场 (14:00-18:00)", "durationValue": 0.5, "durationUnit": "half_day"},
                {"key": "evening", "label": "晚场 (19:00-22:00)", "durationValue": 0.5, "durationUnit": "half_day"},
                {"key": "full_day", "label": "全天 (09:00-22:00)", "durationValue": 1, "durationUnit": "day"},
            ],
            "minDuration": 0.5,
            "maxDuration": 7,
            "advanceDays": 14,
    ...
    "dining_room": {
        ...
        "bookingRequired": True,
        "defaultUnit": "餐",
        "description": "商务餐厅、VIP包间预订",
        "config": {
            "mealSessions": [
                {"key": "breakfast", "label": "早餐 (07:00-09:00)", "startTime": "07:00", "endTime": "09:00"},
                {"key": "lunch", "label": "午餐 (11:30-13:30)", "startTime": "11:30", "endTime": "13:30"},
                {"key": "dinner", "label": "晚餐 (17:30-21:00)", "startTime": "17:30", "endTime": "21:00"},
            ],
            "advanceDays": 7,
            "mealStandards": [
                {"key": "standard", "label": "标准餐"},
                {"key": "vip", "label": "VIP餐"},
                {"key": "luxury", "label": "豪华餐"},
            ],
        },
    },
    "office_desk": {
...
UNIT_CONFIGS = [
    ...
    {"value": "提", "label": "提", "category": "physical"},
    {"value": "个", "label": "个", "category": "physical"},
    {"value": "项", "label": "项", "category": "service"},
    {"value": "小时", "label": "小时", "category": "time"},
    {"value": "半天", "label": "半天", "category": "time"},
    {"value": "天", "label": "天", "category": "time"},
    {"value": "周", "label": "周", "category": "time"},
    {"value": "月", "label": "月", "category": "time"},
